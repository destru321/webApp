...
<head>
    ...
    <script src="js scripts/landingPage.js" defer></script>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Montserrat&family=Roboto&family=Secular+One&display=swap" rel="stylesheet">
...
<body>
    <header class="header">
        ...
        <ul class="header__list" id="headerNav">
            <li class="header__item">
                ...
                <nav class="navigation" id="computerComponentsNav">
            ...
            <li class="header__item">
                <h3 id="periferialDevices">
                    Periferial Devices
                </h3>
                <nav class="navigation" id="periferialDevicesNav">
                    <ul class="navigation__list">
                        <li class="navigation__item">
                            Płyty główne
                        </li>
            ...
            <li class="header__item">
                ...
                <nav class="navigation" id="smartphonesNav">
                    <ul class="navigation__list">
                        <li class="navigation__item">
                            Płyty główne
                        </li>
            ...
            <li class="header__item">
                ...
                <nav class="navigation" id="desktopsNav">
                    <ul class="navigation__list">
                        <li class="navigation__item">
                            Płyty główne
                        </li>
            ...
            <li class="header__item header__item--accesories">
                ...
                <nav class="navigation" id="accesoriesNav">
                    <ul class="navigation__list">
                        <li class="navigation__item">
                            Płyty główne
                        </li>
    ...
    <main class="main">
        <section class="main__section">
            <h1 class="main__heading main__heading--move">
                Curious offerts
            </h1>
            <div class="card-arrows--wrapper">
